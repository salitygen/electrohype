...
class ArticleModel extends AdminModel implements WorkflowModelInterface
{
	...
	protected function cleanupPostBatchCopy(TableInterface $table, $newId, $oldId)
	{
		...
		$oldItem->load($oldId);
		$fields = FieldsHelper::getFields('com_content.article', $oldItem, false);
	...
	protected function batchMove($value, $pks, $contexts)
	{
		...
		foreach ($pks as $pk)
		{
			...
			$fields = FieldsHelper::getFields('com_content.article', $this->table, false);
		...
		Factory::getApplication()->triggerEvent('onContentAfterBatchSave', array('com_content.article', $pks, false, $value));
