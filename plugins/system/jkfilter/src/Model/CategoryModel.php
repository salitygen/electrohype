...
class CategoryModel extends ListModel
{
	...
	public function getItems()
	{
		...
		if ($this->_articles === null && $category = $this->getCategory())
		{
            ...
            $model->setState('filter.article_id.include',$app->getUserState('filter.article_id.include'));
            $model->setState('filter.article_id',$app->getUserState('filter.article_id'));
