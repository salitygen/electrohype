...
namespace Joomla\Module\ArticlesViewed\Site\Helper;
...
/**
 * Helper for mod_articles_viewed
 *
 * @since  1.6
 */
abstract class ArticlesViewedHelper
{
	/**
	...
	public static function getList(&$params)
	{
		...
		if($params->latest){
			$model->setState('filter.article_id', $params->latest);
		}
		...
		foreach ($items as &$item)
		{
			...
			$item->introtext = HTMLHelper::_('content.prepare', $item->introtext, '', 'mod_articles_viewed.content');
